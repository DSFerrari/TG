...
export default function ButtonMAI({name, limpo,icon,tamanho,...props}){
return(
    <View style={{marginTop: 32}}>
        <TouchableOpacity {...props} style={[styles.Button,{backgroundColor: limpo? theme.COLORS.BLUE1 : theme.COLORS.WHITE3}]}>
            {icon && <Ionicons name={icon} size={20} color={limpo? theme.COLORS.WHITE3 :theme.COLORS.BLACK1} style={styles.icon}/>}
